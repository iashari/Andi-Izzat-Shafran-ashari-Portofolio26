...
const socialLinks = [
  {
    name: "GitHub",
    href: "https://github.com/izzatshafran",
    icon: (
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/in/izzatshafran",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Twitter",
    href: "https://twitter.com/izzatshafran",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/izzatshafran",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
